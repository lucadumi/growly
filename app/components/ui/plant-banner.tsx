...
export default function PlantBanner() {
  return (
    <div className="relative overflow-hidden rounded-xl bg-linear-to-br from-card/30 via-light-yellow/80 to-green-soft/70 shadow-inner lg:p-4 xl:p-7 2xl:p-10">
