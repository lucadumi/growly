      ...
      <div className="grid lg:gap-2 xl:gap-3">
        ...
        <label className="flex flex-col gap-1 lg:text-[11px] xl:text-xs 2xl:text-sm">
          ...
          <input
            ...
            className="rounded-2xl lg:px-3 xl:px-4 lg:py-1 xl:py-2 lg:text-[11px] xl:text-xs 2xl:text-sm shadow-inner focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/40"
          />
        </label>
        <label className="flex flex-col gap-1 lg:text-[11px] xl:text-xs 2xl:text-sm">
